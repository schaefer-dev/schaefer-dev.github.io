...
Over a couple of months I developed of a proof of concept that showed what a deep LLM integration can contribute to the in-car assistant experience for all VW brands. The demonstrator ran on production hardware and was integrated into the existing vehicle architecture. Beyond building the full featureset, I established automated testing and regression analysis for llm-agent behavior to catch regressions in prompts, tools, and retrieval logic early. The PoC already significantly exceeded expectations of internal and external stakeholders after 3-4 weeks. Following development and integration of additional features - showcasing further advantages of this new assistant architecture, the PoC directly led to successful customer acquisition. Semvox is now fully committed to this new product generation, now called geni:OS genAI, that builds on top of the findings in this PoC.
